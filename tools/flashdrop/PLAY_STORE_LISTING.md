# FileSetu — Google Play listing draft
...
## Full description
FileSetu is a Made-in-India local file-transfer utility designed for fast Android-to-Windows backups over your own Wi-Fi or phone hotspot.
...
- Pause and resume from FileSetu Desktop
...
- No FileSetu cloud account
- No developer-operated file storage
- No data retention on developer-controlled servers

How it works:
1. Install FileSetu on Android.
2. Start FileSetu and note the temporary session PIN.
3. Connect the Windows PC to the same Wi-Fi/hotspot.
4. Run FileSetu Desktop, choose the phone folder and PC destination, and transfer.

Privacy:
Transfers occur directly between your devices on the local network. FileSetu does not upload your files to a developer-controlled cloud service.
